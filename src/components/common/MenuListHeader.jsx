...
class MenuListHeader extends React.Component{
    ...
    render() {
        const image = this.props.user !== null && this.props.user.pictureUrl !== null
            ? (
                <div>
        ...
        return (
            <div className="menu-list-header">
                ...
                <Popper placement="top-end" className="menu-header-popper" open={Boolean(this.state.anchorEl)} anchorEl={this.state.anchorEl} transition disablePortal>
                        ...
                        <Paper id="menu-list-grow" >
                            <ClickAwayListener onClickAway={this.handleClose}>
                                <MenuList>
                                    <MenuItem
                                    component={Link}
                                    to={ this.props.isDriver ? "/driver/profile" : "/passenger/profile" }
