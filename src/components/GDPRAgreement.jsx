        ...
        return (
            <div className="gdpr-checkbox">
                ...
                <Modal open={open} onClose={this.onCloseModal} center>
                    <h1 style={{textAlign: "center", color:"#173f5f"}}>Privacy Policy</h1>


                    <p style={{textAlign: "center"}}>Effective date: April 01, 2019</p>
                    ...
                    <h2 style={{color: "#20639b"}}>Information Collection And Use</h2>
                    ...
                    <h2 style={{color: "#20639b"}}>Use of Data</h2>
                    ...
                    <h2 style={{color: "#20639b"}}>Transfer Of Data</h2>
                    ...
                    <h2 style={{color: "#20639b"}}>Disclosure Of Data</h2>

                    <h3 style={{textAlign: "center"}}>Legal Requirements</h3>
